...
export const FUNDET_INVOKE = {
  ...
  SKILLHUB_LIST: 'skillhub:list',
  SKILLHUB_DETAIL: 'skillhub:detail',
  SKILLHUB_INSTALL: 'skillhub:install',
  SKILLHUB_UPDATES: 'skillhub:updates',
  /** 自动化（定时例行任务） */
  ...
  AUTOMATIONS_SET_PAUSED: 'automations:set-paused',
  FS_HOME: 'fs:home',
